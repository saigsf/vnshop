<template>
        ...
        <div class="container">
            ...
            <div class="footer-links clearfix">
                ...
                <dl class="col-links">
                    ...
                    <dd>
                        <a href="article.php?id=14" target="_blank" title="格美之家" rel="nofollow">格美之家</a>
                    </dd>
                ...
                <dl class="col-links">
                    <dt>关于格美</dt>
                    <dd>
                        <a href="article.php?id=24" target="_blank" title="联系格美" rel="nofollow">联系格美</a>
                    </dd>
                    <dd>
                        <a href="article.php?id=25" target="_blank" title="加入格美" rel="nofollow">加入格美</a>
                    </dd>
                    <dd>
                        <a href="article.php?id=26" target="_blank" title="了解格美" rel="nofollow">了解格美</a>
                    </dd>
                ...
                <dl class="col-links">
                    ...
                    <dd>
                        <a href="article.php?id=16" target="_blank" title="格美部落" rel="nofollow">格美部落</a>
                    </dd>
                    <dd>
                ...
                <div class="col-contact">
                    <p class="phone">535-789-859</p>
                    <p>周一至周日 8:00-18:00<br>（投诉QQ）</p>
    ...
    <div class="site-info">
        <div class="container">
            <div class="logo ir">格美官网</div>
            <div class="info-text">
                <p class="sites">
                </p>
                <p>
                    ©<a href='#'>vnshop.cn</a> 京ICP证110507号 京ICP备10046444号 京公网安备1101080212535号 <a href='#'>京网文[2014]0059-0009号</a>
                </p>
            </div>
